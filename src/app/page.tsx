...
export default function GalleryPage() {
  return (
    <div className="gallery-root page-width">
      ...
      <footer className="flex flex-wrap items-center justify-between gap-x-6 gap-y-0.5 px-2 py-2 text-xs leading-4 text-zinc-500">
        <Credits />
        <p>
          Paintings by Mojang Studios. Not affiliated with Mojang or Microsoft.
        </p>
      </footer>
    </div>
  );
